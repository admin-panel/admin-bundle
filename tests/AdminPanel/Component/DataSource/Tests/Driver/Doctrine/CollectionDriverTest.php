...
use AdminPanel\Component\DataSource\Extension\Symfony\Core\CoreExtension as CoreDataSourceExtension;
...
class CollectionDriverTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testComparingWithZero()
    {
        ...
        $driverOptions = [
            'collection' => $this->em->getRepository('AdminPanel\Component\DataSource\Tests\Fixtures\News')->findAll(),
        ];
