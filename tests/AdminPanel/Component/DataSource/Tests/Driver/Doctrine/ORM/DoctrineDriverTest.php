...
class DoctrineDriverTest extends \PHPUnit_Framework_TestCase
{
     ...
     *
     * @return \AdminPanel\Component\DataSource\Driver\Doctrine\ORM\DoctrineFactory.
     */
    private function getDoctrineFactory()
    {
        ...
        return new \AdminPanel\Component\DataSource\Driver\Doctrine\ORM\DoctrineFactory(new TestManagerRegistry($this->em), $extensions);
    }
