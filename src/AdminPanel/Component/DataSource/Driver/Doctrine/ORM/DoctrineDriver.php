...
namespace AdminPanel\Component\DataSource\Driver\Doctrine\ORM;
    ...
    public function buildResult($fields, $first, $max)
    {
        foreach ($fields as $field) {
            if (!$field instanceof DoctrineFieldInterface) {
                throw new DoctrineDriverException(sprintf('All fields must be instances of AdminPanel\Component\DataSource\Driver\Doctrine\ORM\DoctrineFieldInterface.'));
            }
